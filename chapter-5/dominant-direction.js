...
function dominantDirection(text) {
  ...
  scripts.forEach(({ name, count }) => {
    if (maxUsageVal < count) {
      maxUsageVal = count;
      maxUsedScript = name;
    }
  });
  return SCRIPTS.find((obj) => obj.name === maxUsedScript).direction;
}
...
// standard solution is more straight-forward and better than mine,
// have to accept, chapter examples had an influence on my thinking
// -------------------------------
// standard solution
function dominantDirection(text) {
